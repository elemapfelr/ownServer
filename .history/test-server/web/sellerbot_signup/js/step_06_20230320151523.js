...
function ticketSelect() {
	...
	document.querySelector('#prevTicket').addEventListener('click', () => {
		...
		document.querySelector('#ticketName') = tickets[index]['name'];
		document.querySelector('#ticketPrice') = tickets[index]['price'];
		document.querySelector('#totalPrice') = tickets[index]['price'];
	});
